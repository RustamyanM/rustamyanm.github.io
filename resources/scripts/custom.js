...
//        }
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
		...
		setTimeout(function(){
            ...
            $('.manual-slider').owlCarousel({loop:true, margin:0, nav:false, lazyLoad:true, items:1, autoplay: false, autoplayTimeout:false});		
			...
			var call_charts_to_page = function(){
				new Chart(document.getElementById("pie-chart"), {
                    ...
                    data: {
					  ...
					  datasets: [{
						backgroundColor: ["#d0006f", "#4FC1E9", "#A0D468"],
